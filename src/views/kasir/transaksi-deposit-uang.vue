        ...
        <div width="600px" class="p-1">
          <table class="border">
            <tr>
              ...
              <td>No Struk : {{ transaksiDepo.no_struk }}</td>
            </tr>
            <td>
            ...
            <td>
              Tanggal :
              {{ transaksiDepo.transaksi_deposit_uang.tanggal_deposit_uang }}
            </td>
                ...
                <table>
                  ...
                  <tr>
                    ...
                    <td>
                      Rp.
                      {{
                        transaksiDepo.transaksi_deposit_uang.bonus_deposit_uang
                      }}
                    </td>
                  </tr>
                  <tr>
  ...
  methods: {
    ...
    updateNominalPromo() {
      ...
      try {
        ...
        this.formData.total_deposit_uang =
          parseInt(this.formData.nominal_deposit_uang) +
          parseInt(localPromo.bonus_promo);
      } catch {
