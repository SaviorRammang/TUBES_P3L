    ...
    <v-card>
      <v-card-title>
        <v-list-item-avatar color="darkgrey">
          <img
            src="https://i.pinimg.com/564x/65/70/7d/65707df9bf6745c6cb950a22ff5295b9.jpg"
          />
        </v-list-item-avatar>
        <v-spacer></v-spacer>
        <v-text-field
            ...
            <v-card color="white">
              ...
              <v-card-actions>
                ...
                <v-btn
                  color="red darken-1"
                  text
                  @click="resetPassword(item.id_member)"
                >
                  Reset
                </v-btn>
              </v-card-actions>
        ...
        <v-card-text>
          <v-container>
            <v-row>
              ...
              <v-btn color="red" outlined @click="CetakStruk(item)"
                >Cetak Card Member</v-btn
              >

              <v-btn color="blue" outlined @click="cancelCetak(item)"
                >Cancel</v-btn
              >
            </v-row>
          </v-container>
...
export default {
  ...
  methods: {
    ...
    CetakStruk() {
      ...
      doc.setFont(undefined, 'normal');
      doc.text(
        `Member ID : ${this.member['id_member']}`,
        10,
        40,
        null,
        null,
